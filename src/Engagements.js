...
import jnac from './assets/jnac.png'
import jnac2 from './assets/jnac2.png'
    ...
    <div className="community">
      ...
      <div className='econtainer'>
        <div className='erow'>
            ...
            <Engagement title="Happy Teens For the Future Conference"  image={tftf} image2={tftf3} />
            <Engagement title="Flow Network, Uyo: Become a Web3 OG; The Benefits of Value Contribution" image={flown} image2={flown} />
        ...
        <div className='erow'>
            ...
            <Engagement title="JNAC Blockchain Invasion." image={jnac2} image2={jnac}  />
            <Engagement title="FTT DAO Blockchain Event: Growing in the Web3 Ecosystem" image={shardeum} image2={shardeum2}  />
        </div>
      </div>
    </div>
  )
